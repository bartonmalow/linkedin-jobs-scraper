...
exports.AnonymousStrategy = exports.Selectors = void 0;
 ...
 * @extends RunStrategy
 */
class AnonymousStrategy extends RunStrategy_1.RunStrategy {
    constructor() {
        super(...arguments);
        /**
         * Run strategy
        ...
        this.run = (browser, page, cdpSession, url, query, location) => __awaiter(this, void 0, void 0, function* () {
            ...
            if ((yield _a._needsAuthentication(page))) {
            ...
            while (processed < query.options.limit) {
                ...
                while (jobIndex < jobsTot && processed < query.options.limit) {
                    ...
                    try {
                        ...
                        loadJobDetailsResult = yield _a._loadJobDetails(page, jobId);
                ...
                const loadMoreJobsResult = yield _a._loadMoreJobs(page, jobsTot);
 ...
 * @private
 */
AnonymousStrategy._needsAuthentication = (page) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 * @private
 */
AnonymousStrategy._loadJobDetails = (page_1, jobId_1, ...args_1) => __awaiter(void 0, [page_1, jobId_1, ...args_1], void 0, function* (page, jobId, timeout = 2000) {
    const waitTime = 50;
    let elapsed = 0;
    let loaded = false;
    while (!loaded) {
 ...
 * @private
 */
AnonymousStrategy._loadMoreJobs = (page_1, jobLinksTot_1, ...args_1) => __awaiter(void 0, [page_1, jobLinksTot_1, ...args_1], void 0, function* (page, jobLinksTot, timeout = 2000) {
 ...
 * @param {string} tag
 */
AnonymousStrategy._acceptCookies = (page, tag) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield page.evaluate(() => {
