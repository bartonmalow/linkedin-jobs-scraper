...
class AuthenticatedStrategy extends RunStrategy_1.RunStrategy {
    constructor() {
        ...
        this.run = (browser, page, cdpSession, url, query, location) => __awaiter(this, void 0, void 0, function* () {
            ...
            url = _url.href;
            // Random delay between companies (1-3 minutes)
            yield (0, utils_1.sleep)(Math.random() * 120000 + 60000);
            // Open search url
            ...
            try {
                yield page.waitForSelector(exports.selectors.container, { timeout: 10000 });
            }
            catch (err) {
                logger_1.logger.error(' run.waitForSelector ERROR: ', err);
                    ...
                    try {
                        ...
                        const jobFieldsResult = yield page.evaluate((jobsSelector, linkSelector, titleSelector, companySelector, placeSelector, dateSelector, jobIndex) => {
                            ...
                            const date = job.querySelector(dateSelector)
                                ...
                                : '';
                            const isPromoted = !!Array.from(job.querySelectorAll('li')).find(e => e.innerText === 'Promoted');
                            return {
                                jobId,
                                jobLink,
                                title,
                        ...
                        logger_1.logger.debug(tag, 'Evaluating selectors', [exports.selectors.jobs]);
                        loadDetailsResult =
                            yield _a._loadJobDetails(page, jobId);
                        // Check if loading job details has failed
                        if (!loadDetailsResult.success) {
                            logger_1.logger.error('Loading job details has failed: ', loadDetailsResult.error);
                            jobIndex += 1;
                            continue;
                        }
                        ...
                        jobDateText = yield page.evaluate(selector => {
                            const el = document.querySelector(selector);
                            if (el) {
                                return el.innerText;
                            }
                        ...
                        if ((_e = query.options) === null || _e === void 0 ? void 0 : _e.skills) {
                            try {
                                yield page.waitForSelector(exports.selectors.requiredSkills, { timeout: 5000 });
                                ...
                                logger_1.logger.info('Timeout loading skills selector: ', err);
                            }
                        }
                        ...
                        jobInsights = yield page.evaluate((jobInsightsSelector) => {
                            ...
                            return Array.from(nodes).map(e => e
                                .textContent.replace(/[\n\r\t ]+/g, ' ')
                                .trim());
                        }, exports.selectors.insights);
                        // Apply link
 ...
 * @private
 */
AuthenticatedStrategy._loadJobs = (page_1, jobsTot_1, ...args_1) => __awaiter(void 0, [page_1, jobsTot_1, ...args_1], void 0, function* (page, jobsTot, timeout = 5000) {
    ...
    try {
        ...
        logger_1.logger.error('_loadJobs ERROR: ', err);
    }
    return {
        success: false,
 ...
 * @private
 */
AuthenticatedStrategy._loadJobDetails = (page_1, jobId_1, ...args_1) => __awaiter(void 0, [page_1, jobId_1, ...args_1], void 0, function* (page, jobId, timeout = 5000) {
    const pollingTime = 50;
    let elapsed = 0;
    let loaded = false;
    yield (0, utils_1.sleep)(pollingTime);
    try {
        ...
        logger_1.logger.error('_loadJobDetails ERROR: ', err);
    }
    return {
        success: false,
 ...
 * @private
 */
AuthenticatedStrategy._paginate = (page_1, tag_1, ...args_1) => __awaiter(void 0, [page_1, tag_1, ...args_1], void 0, function* (page, tag, paginationSize = 25, timeout = 5000) {
...
AuthenticatedStrategy._acceptCookies = (page, tag) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        logger_1.logger.debug(tag, 'Failed to accept cookies: ', err);
    }
});
/**
 * Accept privacy
...
AuthenticatedStrategy._acceptPrivacy = (page, tag) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield page.evaluate(selector => {
            const privacyButton = Array.from(document.querySelectorAll(selector)).find(e => e.innerText === 'Accept');
            if (privacyButton) {
                privacyButton.click();
            }
 ...
 */
AuthenticatedStrategy._extractApplyLink = (page_1, cdpSession_1, tag_1, ...args_1) => __awaiter(void 0, [page_1, cdpSession_1, tag_1, ...args_1], void 0, function* (page, cdpSession, tag, timeout = 4) {
    try {
        ...
        if (yield page.evaluate((applyBtnSelector) => {
            ...
            while (elapsed < timeout) {
                ...
                if (targetsResponse.targetInfos &&
                    ...
                    for (const targetInfo of targetsResponse.targetInfos) {
                        if (targetInfo.attached &&
                            ...
                            yield cdpSession.send('Target.closeTarget', {
